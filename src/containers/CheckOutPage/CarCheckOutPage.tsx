...
const CheckOutPage: FC<CheckOutPageProps> = ({ className = "" }) => {
  ...
  const car = useSelector((state: RootState) => state.booking.selectedCar);
  const {
    address,
    author,
    title,
  ...
  // Calculate the number of days using rangeDates.startDate and rangeDates.endDate
      ...
      <div className="w-full flex flex-col sm:rounded-2xl lg:border border-neutral-200 dark:border-neutral-700 space-y-6 sm:space-y-8 px-0 sm:p-6 xl:p-8">
        <div className="flex flex-col sm:flex-row sm:items-center">
          <div className="flex-shrink-0 w-full sm:w-40">
            <div className=" aspect-w-5 aspect-h-3 sm:aspect-h-4 rounded-2xl overflow-hidden">
              <NcImage
          ...
          <div className="py-5 sm:px-5 space-y-3 ">
            ...
            <span className="block  text-sm text-neutral-500 dark:text-neutral-400">
              {seats && seats} seats · {gearshift && gearshift}
            </span>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex justify-between text-neutral-6000 dark:text-neutral-300">
            <span> {price && price}x {numberOfDays && numberOfDays} day</span>
